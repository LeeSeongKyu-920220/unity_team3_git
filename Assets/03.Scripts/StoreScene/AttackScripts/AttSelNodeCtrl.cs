...
public class AttSelNodeCtrl : MonoBehaviour
{
    ...
    public void ItemSel(string UnitName, int UnitLevel, int UnitHp, int UnitAtt,
        int UnitDef, float UnitAttSpeed, float UnitSpeed, int UnitMoveable, AttUnitState isBuyState,
